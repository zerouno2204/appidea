...
class Add5c00fe2d39f80RelationshipsToCongressEntryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('congress_entries', function(Blueprint $table) {
            if(Schema::hasColumn('congress_entries', 'id_congress_id')) {
                $table->dropForeign('234199_5c00f7c89e356');
                $table->dropIndex('234199_5c00f7c89e356');
                $table->dropColumn('id_congress_id');
            }
            if(Schema::hasColumn('congress_entries', 'id_entry_id')) {
                $table->dropForeign('234199_5c00f7c8aeba9');
                $table->dropIndex('234199_5c00f7c8aeba9');
