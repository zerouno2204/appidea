...
class EventsController extends Controller
{
    ...
    public function create()
    {
        ...
        $id_salas = \App\Hall::get()->pluck('nome', 'id')->prepend(trans('global.app_please_select'), '');

        return view('admin.events.create', compact('id_salas'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.events.edit', compact('event', 'id_salas'));
    }
