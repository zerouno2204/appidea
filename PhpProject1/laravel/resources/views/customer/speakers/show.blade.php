...
<div class="mdl-card">
    ...
    <div class="mdl-card__actions">
        <a href="{{url('admin/speaker-congress/'.$congress->id)}}" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">@lang('global.app_back_to_list')</a>
    </div>
</div>
@stop
