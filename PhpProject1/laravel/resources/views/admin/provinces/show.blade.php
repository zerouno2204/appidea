...
@section('content')
    <h3 class="page-title">@lang('global.provinces.title')</h3>
...
<li role="presentation" class="active"><a href="#cities" aria-controls="cities" role="tab" data-toggle="tab">Città</a></li>
<li role="presentation" class=""><a href="#hotels" aria-controls="hotels" role="tab" data-toggle="tab">Hotel</a></li>
...
{!! Form::open(array(
        ...
        @endif
            ...
            <a href="{{ route('admin.provinces.index') }}" class="btn btn-default">@lang('global.app_back_to_list')</a>
        </div>
    </div>
@stop
