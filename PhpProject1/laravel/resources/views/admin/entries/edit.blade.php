...
<div class="mdl-card">
    <div class="mdl-card__title mdl-card--border">
        <h3 class="mdl-card__title ">@lang('global.entry.title')  @lang('global.app_edit')</h3>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4 form-group">
                ...
                <select name="congresso" class="form-control select2">
                    ...
                    <option value="{{$congress->id}}" @if($congress->id == $congress_entry->id_congress_id ) selected @endif >{{$congress->nome}}</option>
                    @endforeach
                </select>
            </div>
            <div class="col-sm-4 form-group">
