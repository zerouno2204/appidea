        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('nome', trans('global.images.fields.nome').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('path', trans('global.images.fields.path').'', ['class' => 'control-label']) !!}
                    {!! Form::file('path[]', [
                        'multiple',
                    ...
                    <div class="photo-block">
                        ...
                        <div class="files-list">
                            @foreach($image->getMedia('path') as $media)
                                <p class="form-group">
                                    <a href="{{ $media->getUrl() }}" target="_blank">{{ $media->name }} ({{ $media->size }} KB)</a>
                                    <a href="#" class="btn btn-xs btn-danger remove-file">Remove</a>
                                    <input type="hidden" name="path_id[]" value="{{ $media->id }}">
                                </p>
                            @endforeach
                        </div>
                    </div>
